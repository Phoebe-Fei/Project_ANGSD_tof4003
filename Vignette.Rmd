...
![](/Users/phoebefei/Desktop/WCM/W2022/CMPB 5004/Project/ANGSD Project tof4003/bed input.png)
```bash
cd /athena/angsd/scratch/tof4003/project
mkdir -p RSeQC
--exit--
...
mv NMR_female_ref NMR_female_ref.bed
```
...
for file in *.bam; do
 ...
 -r /athena/angsd/scratch/tof4003/project/RSeQC/NMR_female_ref.bed > \
 /athena/angsd/scratch/tof4003/project/RSeQC/distribution/star/${fv}${suf}_rseqc_distribution.out
done
...
cd /athena/angsd/scratch/tof4003/project/liver_hisat2/male_out
for file in *.bam; do
 echo $file
 fv=$(cut -d "." -f 1 )
 suf=$(cut -d "." -f 2)
 read_distribution.py -i ${file} \
 -r /athena/angsd/scratch/tof4003/project/RSeQC/NMR_female_ref.bed > \
 /athena/angsd/scratch/tof4003/project/RSeQC/distribution/hisat2/${fv}${suf}_rseqc_distribution.out
done
cd /athena/angsd/scratch/tof4003/project/liver_hisat2/female_out
for file in *.bam; do
 echo $file
 fv=$(cut -d "." -f 1 )
 suf=$(cut -d "." -f 2)
...
#star
cd cd /athena/angsd/scratch/tof4003/project/star_liver/male_out
for file in *.bam; do
 echo $file
 fv=$(cut -d "." -f 1 )
 suf=$(cut -d "." -f 2)
 ...
 -r /athena/angsd/scratch/tof4003/project/RSeQC/NMR_female_ref.bed > \
 /athena/angsd/scratch/tof4003/project/RSeQC/coverage/star/${fv}${suf}_rseqc_coverage.out
done

cd cd /athena/angsd/scratch/tof4003/project/star_liver/female_out
for file in *.bam; do
 echo $file
 fv=$(cut -d "." -f 1 )
 suf=$(cut -d "." -f 2)
...
for file in *.bam; do
 ...
 geneBody_coverage.py -i $file \
 -r /athena/angsd/scratch/tof4003/project/RSeQC/NMR_female_ref.bed > \
 /athena/angsd/scratch/tof4003/project/RSeQC/coverage/hisat2/${fv}${suf}_rseqc_coverage.out
done

cd cd /athena/angsd/scratch/tof4003/project/liver_hisat2/female_out
for file in *.bam; do
 echo $file
 fv=$(cut -d "." -f 1 )
 suf=$(cut -d "." -f 2)
...
Merge male and female data & create rowData
```{r}
#Create rownames
