...
for file in *.fastq; do
  ...
  fv=$(cut -d "." -f 1 <<< "$file")
  suf=$(cut -d "." -f 2 <<< "$file")
  hisat2 -q -p 2 -x /athena/angsd/scratch/tof4003/project/NMR_ref/hisat2_index_NMR_male/HISAT2_NMR_male --summary-file $fv.$suf.summary.txt -U $file -S /athena/angsd/scratch/tof4003/project/liver_hisat2/out_male/$fv.$suf.hisat2.sam
...
for file in *.fastq; do
  ...
  fv=$(cut -d "." -f 1 <<< "$file")
  suf=$(cut -d "." -f 2 <<< "$file")
  hisat2 -q -p 2 -x /athena/angsd/scratch/tof4003/project/NMR_ref/hisat2_index_NMR_female/HISAT2_NMR_female --summary-file $fv.$suf.summary.txt -U $file -S /athena/angsd/scratch/tof4003/project/liver_hisat2/out_female/$fv.$suf.hisat2.sam
  #use samtools to covert to bam, sort& index
  #sort & covert to bam
...
cp /athena/angsd/scratch/tof4003/project/liver_hisat2/male_out/*.txt hisat2
cp /athena/angsd/scratch/tof4003/project/liver_hisat2/female_out/*.txt hisat2
...
||                           S SRR5517433.m_breeder.hisat2.sorted.bam         ||
||                           S SRR5517434.m_breeder.hisat2.sorted.bam         ||
||                           S SRR5517438.m_breeder.hisat2.sorted.bam         ||
||                           S SRR5517442.m_non-breeder.hisat2.sorted.bam     ||
||                           S SRR5517443.m_breeder.hisat2.sorted.bam         ||
||                           S SRR5517444.m_non-breeder.hisat2.sorted.bam     ||
||                           S SRR5517447.m_breeder.hisat2.sorted.bam         ||
||                           S SRR5517448.m_non-breeder.hisat2.sorted.bam     ||
||                           S SRR5517451.m_non-breeder.hisat2.sorted.bam     ||
||                           S SRR5517452.m_non-breeder.hisat2.sorted.bam     ||
||                           S SRR5517453.m_non-breeder.hisat2.sorted.bam     ||
||                           S SRR5517454.m_breeder.hisat2.sorted.bam         ||
||                                                                            ||
||             Output file : hisat2_featCounts_maleNMR.txt                    ||
||                 Summary : hisat2_featCounts_maleNMR.txt.summary            ||
||              Annotation : maleNMR.gtf (GTF)                                ||
...
//================================= Running ==================================\\
||                                                                            ||
|| Load annotation file maleNMR.gtf ...                                       ||
||    Features : 311975                                                       ||
||    Meta-features : 32747                                                   ||
||    Chromosomes/contigs : 3176                                              ||
||                                                                            ||
|| Loading FASTA contigs : NMR_ref/NMR_ref_male.fa                            ||
||    39267 contigs were loaded                                               ||
||                                                                            ||
|| Process BAM file SRR5517433.m_breeder.hisat2.sorted.bam...                 ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 31648521                                                  ||
||    Successfully assigned reads : 17859080 (56.4%)                          ||
||    Running time : 0.68 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517434.m_breeder.hisat2.sorted.bam...                 ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 28006735                                                  ||
||    Successfully assigned reads : 14121939 (50.4%)                          ||
||    Running time : 0.58 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517438.m_breeder.hisat2.sorted.bam...                 ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 31671946                                                  ||
||    Successfully assigned reads : 17615218 (55.6%)                          ||
||    Running time : 0.67 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517442.m_non-breeder.hisat2.sorted.bam...             ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 35668328                                                  ||
||    Successfully assigned reads : 20403671 (57.2%)                          ||
||    Running time : 0.62 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517443.m_breeder.hisat2.sorted.bam...                 ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 28201076                                                  ||
||    Successfully assigned reads : 16133122 (57.2%)                          ||
||    Running time : 0.60 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517444.m_non-breeder.hisat2.sorted.bam...             ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 33773769                                                  ||
||    Successfully assigned reads : 19822237 (58.7%)                          ||
||    Running time : 0.69 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517447.m_breeder.hisat2.sorted.bam...                 ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 27634289                                                  ||
||    Successfully assigned reads : 13964052 (50.5%)                          ||
||    Running time : 0.51 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517448.m_non-breeder.hisat2.sorted.bam...             ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 36089676                                                  ||
||    Successfully assigned reads : 18205088 (50.4%)                          ||
||    Running time : 0.68 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517451.m_non-breeder.hisat2.sorted.bam...             ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 33681691                                                  ||
||    Successfully assigned reads : 17988655 (53.4%)                          ||
||    Running time : 0.61 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517452.m_non-breeder.hisat2.sorted.bam...             ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 25749115                                                  ||
||    Successfully assigned reads : 14528459 (56.4%)                          ||
||    Running time : 0.44 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517453.m_non-breeder.hisat2.sorted.bam...             ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 28856411                                                  ||
||    Successfully assigned reads : 16960849 (58.8%)                          ||
||    Running time : 0.55 minutes                                             ||
||                                                                            ||
|| Process BAM file SRR5517454.m_breeder.hisat2.sorted.bam...                 ||
||    Single-end reads are included.                                          ||
||    Assign reads to features...                                             ||
||    Total reads : 32775421                                                  ||
||    Successfully assigned reads : 18034481 (55.0%)                          ||
||    Running time : 0.56 minutes                                             ||
||                                                                            ||
||                         Read assignment finished.                          ||
||                                                                            ||
|| Summary of counting results can be found in file "featureCounts/hisat2_fe  ||
|| atCounts_maleNMR.txt.summary"                                              ||
||                                                                            ||
\\===================== http://subread.sourceforge.net/ ======================//
...
DESeq.hisatf <- DESeqDataSetFromMatrix(countData = as.matrix(rchisat_f),
                                   colData = sampleinfo_hisatf,
                                   design = ~ condition ) 
```

2. run multiQC on star log file and hisat2 slurm file (rename the file)
3. RSeQC/QoRTs on bam file & gtf (instead of bamqc)
4. Only keep the ones with same gene name between male & female, male and female should be in one object (cbind) design = ~ condition + sex 
